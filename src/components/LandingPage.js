...
const LandingPage = () => {
  return (
    <div className="page-container">
      ...
      <p>Welcome to my portfolio! Feel free to explore and delve into the world of my projects, experiences, and skills. Within these pages, you will discover a glimpse into my journey as a professional, showcasing my passion for innovation and dedication to excellence.
